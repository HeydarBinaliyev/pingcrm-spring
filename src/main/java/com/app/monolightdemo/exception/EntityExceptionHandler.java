...
public class EntityExceptionHandler {
	...
	public ResponseEntity<ExceptionResponse> handleNonUniqueException(NonUniqueResultException exception,
	...
	public ResponseEntity<ExceptionResponse> handleNoResultException(NoResultException exception,
			HttpServletRequest request) {
		exception.printStackTrace();
